        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoomCost = table.Column<decimal>(type: "TEXT", precision: 18, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoomServices", x => new { x.ConferenceRoomId, x.ServiceId });
                    table.ForeignKey(
                        name: "FK_RoomServices_ConferenceRooms_ConferenceRoomId",
                        column: x => x.ConferenceRoomId,
                        principalTable: "ConferenceRooms",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bookings_ConferenceRoomId_StartTime_EndTime",
                table: "Bookings",
                columns: new[] { "ConferenceRoomId", "StartTime", "EndTime" });
